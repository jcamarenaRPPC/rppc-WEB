...
@Component({
  selector: 'ngx-inscripciones-entregadas-error',
  templateUrl: './InscripcionesEntregadasError.component.html',
  styleUrls: ['./InscripcionesEntregadasError.component.scss'],
})
export class InscripcionesEntregadasErrorComponent implements OnInit {
  ...
  obtenerDatos() {
    ...
    if (!bolCamposVacios) {
      ...
      this.objServicio.objISOController.InscripcionesEntregadasError(parametros).pipe(first()).subscribe((respuestaServer: any) => {
