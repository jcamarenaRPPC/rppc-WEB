...
@Component({
  selector: 'ngx-iso',
  templateUrl: './CertificadosEntregadosError.component.html',
  styleUrls: ['./CertificadosEntregadosError.component.scss'],
})
export class CertificadosEntregadosErrorComponent implements OnInit {
  ...
  obtenerDatos() {
    ...
    if (!bolCamposVacios) {
      ...
      this.objServicio.objISOController.CertificadosEntregadosError(parametros).pipe(first()).subscribe((respuestaServer: any) => {
