...
@Component({
  selector: 'ngx-ca-por-municipio',
  templateUrl: './caPorMunicipio.component.html',
  styleUrls: ['./caPorMunicipio.component.scss'],
})
export class CaPorMunicipioComponent implements OnInit {
